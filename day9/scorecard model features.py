...
print '读取原始训练数据'
data1_Idx, data2_Idx, data3_Idx = set(data1), set(data2), set(data3)
...
print '写入allData_2a.csv'
trainData.to_csv(path+'/数据/bank default/allData_2a.csv', header=True,encoding='gbk', columns = trainData.columns, index=False)
print '操作var_WOE.pkl文件'
filewrite = open(path+'/数据/bank default/var_WOE.pkl','w')
pickle.dump(var_WOE, filewrite)
filewrite.close()

print '操作var_IV.pkl文件'
...
#########################################################
trainData = pd.read_csv(path+'/数据/bank default/allData_2a.csv', header=0, encoding='gbk')
print '读取allData_2a.csv文件'
...
print '写入文件allData_3.csv'
trainData.to_csv(path+'/数据/bank default/allData_3.csv', header=True,encoding='gbk', columns = trainData.columns, index=False)
...
print '保存模型到LR_Model_Normal.pkl'
